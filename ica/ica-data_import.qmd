...
```{r}
library(tidyverse)
imdb_messy <- read_csv("/Users/apple/Comp 112/portfolio-YyuYan/ica/imdb_5000_messy.csv")
```
...
```{r}
imdb_temp <- read_csv("/Users/apple/Comp 112/portfolio-YyuYan/ica/imdb_5000_messy.csv")
```
...
some of the observations are duplicated
...
it is important to keep the records of data cleaning
...
films with no actor have a lot of missing values
