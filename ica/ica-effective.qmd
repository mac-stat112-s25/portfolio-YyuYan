...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "temperature at 9 am", y = "temperature at 3 pm", title = "temperature of Australia at 9am vs 3pm by location", color = "location")  
```
...
```{r}
#| echo: false
#| fig-cap: "scatter plot showing the relationship between 9 AM and 3PM temperatures in three Australian locations"
...
#| echo: false
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "A density plot showing the distribution of 3 PM temperatures in Hobart, Uluru, and Wollongong, Australia. The peaks of the distributions suggest that certain temperatures are more frequent in each location"
...
It does not start at zero, so the temperature changes look significant. It does not show long term trends
...
It connects personal experience with data storytelling
It uses interactive elements to show symptoms
...
the one I chose is the wind map. It shows the current time wind speed and the direction of wind in the United States. It only shows ten cities and for people who are bad at geography, it's hard to analyze the graphic. 
